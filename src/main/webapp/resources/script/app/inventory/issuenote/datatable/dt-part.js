var IssueNotePartSelectModal = function () {
    ...
    var getPartTable = function (bizId) {
        ...
        var oTable = $('#' + tableId).dataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: '../restapi/asset/tabledata-parts-repairable-by-business?id=' + bizId,
                pages: 5
            }),
            columns: [{
                orderable: false,
            ...
            aoColumnDefs: [{
                ...
                render: function (data, type, row, meta) {
                    ...
                    return ButtonUtil.getCommonBtnSelectWithMultipleVars("IssueNotePartSelectModal.setIssuenotePart", data, vars);
                }
            }],
            oLanguage: {
    ...
    var setIssuenotePart = function (id, name, code) {
        $("#itemPartId").val(id);
    ...
    return {
        ...
        setIssuenotePart: function (id, name, code) {
        	setIssuenotePart(id, name, code);
        },
