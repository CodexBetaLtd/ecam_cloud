    ...
    var initTable = function () {
        ...
        var oTable = $('#tbl_issuenote_list').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "../restapi/issuenote/tabledata",
                pages: 5
            }),
            columns: [
                {
        ...
        $('#tbl_issuenote_list_wrapper .dataTables_length select').select2();
        $('#tbl_issuenote_list_column_toggler input[type="checkbox"]').change(function () {
