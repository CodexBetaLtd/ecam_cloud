var NotificationAddModal = function () {
	...
	var notifyUserSelectModal = function () {
    	...
    	if ( bizId != null && bizId > 0 ) { 
    		var $modal = $('#stock-notification-add-child-modal');
	        CustomComponents.ajaxModalLoadingProgressBar();
	        setTimeout(function () {
	            var url = '../stock/user-select-modal-view';
	            $modal.load(url, '', function () {
	            	UserSelectModal.init("user_select_tbl", bizId, "NotificationAddModal.setNotifyUser");
	                $modal.modal();
	            });
	        }, 1000);
        } else {
