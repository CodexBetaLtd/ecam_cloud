var AODStockSelectModal = function () {
    ...
    var setADOItemStock = function (id, batchNo, wharehouseId, wharehouseName, qtyOnHand) {
        $("#itemStockId").val(id);
    ...
    return {
        ...
        setADOItemStock: function (id, batchNo, wharehouseId, wharehouseName, qtyOnHand) {
            setADOItemStock(id, batchNo, wharehouseId, wharehouseName, qtyOnHand);
        }, 
    };
