var AssetModelDataTable = function () {
    ...
    var runDataTable = function () {
    	...
    	var oTable = $('#assetModelTbl').dataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
            	url: "../restapi/lookuptable/tabledataassetmodelbybrand?id=" + brandId,
                pages: 5
            }),
            columns: [{
                orderable: false,
            ...
            dom : "<'row'<'col-sm-4  dtblassetmodel'><'col-sm-8'f>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-6'i><'col-sm-6'p>>",
        ...
        $('#assetModelTbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#assetModelTbl_wrapper .dataTables_length select').select2();
        $('#assetModelTbl_column_toggler input[type="checkbox"]').change(function () {
