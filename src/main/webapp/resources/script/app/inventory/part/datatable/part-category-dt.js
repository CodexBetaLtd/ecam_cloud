var PartCategoryDataTable = function () {
    ...
    var runDataTable = function () {
        ...
        var oTable = $('#partCategoryTbl').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
            	url: "../restapi/assetCategory/tabledatabytype?type=PARTS_AND_SUPPLIES",
                pages: 5
            }),
            columns: [{
                orderable: false,
			...
			initComplete : function() {
				$("div.dtblassetcategory").html( "<button class='btn btn-blue btn-sm active tooltips' data-toggle='modal' type='button' id='btnAssetCategoryNew' onclick='PartAdd.partCategoryAddView();' ><i class='clip-plus-circle-2  btn-new'></i> New</button>");
			},
