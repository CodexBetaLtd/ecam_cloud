...
var PartLog = function () {
    ...
    var dtPartLog = function (partId) {

        var oTable = $('#part_log_tbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/partlog/table-data-by-part",
                pages: 5,
                data: {
                    "id": partId
                },
        ...
        $('#part_log_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
        $('#part_log_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#part_log_tbl_wrapper .dataTables_length select').select2();
        $('#part_log_tbl_column_toggler input[type="checkbox"]').change(function () {
