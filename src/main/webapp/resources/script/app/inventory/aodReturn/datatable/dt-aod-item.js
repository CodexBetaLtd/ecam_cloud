/*********************************************************************
 * AOD Item Return DataTable
 *********************************************************************/
var dtAODReturnItem = function () {
    ...
    var setADOReturnAODItem = function (id, aodItemPartNo, itemQuantity, description) {
        $("#aodReturnAodItemId").val(id);
        $("#aodReturnAodItemNo").val(aodItemPartNo);
        $("#aodItemQuantity").val(itemQuantity);
        $("#returnDescription").val(description);
        $('#stackable-datatable-modal').modal("hide");
    };


    return {
        dtAODReturnItemList: function (url, func) {
            getAODReturnItemTable(url, func);
         ...
         * Set Data Value
         *********************************************************************/
        setADOReturnAODItem: function (id, aodItemPartNo, itemQuantity, description) {
            setADOReturnAODItem(id, aodItemPartNo, itemQuantity, description);
        },
