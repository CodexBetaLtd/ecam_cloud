var dtRFQSupplier = function () {
    ...
    var initRFQSupplierTable = function () {
        ...
        $('#supplier_select_tbl.dataTables_length select').select2();
        $('#supplier_select_tbl_column_toggler input[type="checkbox"]').change(function () {
