var dtRFQItemAsset = function () {
    ...
    var initRFQAssetTable = function () {
        ...
        $('#rfq_asset_select_tbl_wrapper .dataTables_length select').select2();
        $('#rfq_asset_select_tbl_column_toggler input[type="checkbox"]').change(function () {
