var dtRFQPart = function () {
    ...
    var initRFQAssetTable = function () {
        ...
        $('#rfq_part_select_tbl_wrapper .dataTables_length select').select2();
        $('#rfq_part_select_tbl_column_toggler input[type="checkbox"]').change(function () {
