var NotificationAddModal = function () {
	...
	var initButtons = function () {
		...
		$('#add-rfq-notification-btn').on('click', function () {
	...
	var initInputClear = function () {
        ...
        $("#rfqNotificationUserName").inputClear({
	...
	var notifyUserSelectModal = function () {
    	...
    	if ( bizId != null && bizId > 0 ) { 
    		var $modal = $('#rfq-notification-add-child-modal');
	        CustomComponents.ajaxModalLoadingProgressBar();
	        setTimeout(function () {
	            var url = '../rfq/user-select-modal-view';
    ...
    var addNotification = function () {
        ...
        if ($("#part-notification-add-frm").valid()) {
            ...
            notification['userId'] = $('#rfqNotificationUserId').val();
            notification['userName'] = $('#rfqNotificationUserName').val();
            notification['notifyOnStatusChannged'] = $("#notifyOnStockAdd").prop("checked");
