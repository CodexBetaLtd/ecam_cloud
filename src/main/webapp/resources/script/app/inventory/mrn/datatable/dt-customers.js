/*********************************************************************
 * AOD Customers DataTable
 *********************************************************************/
var MRNCustomers = function () { 
    ...
    var dtCustomerList = function (bizId) {
        ...
        var oTable = $('#' + tableId).DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/customer/tabledata-by-business?id=" + bizId,
                pages: 5
            }),
            columns: [{
                orderable: false,
    ...
    return {
        ...
        init: function (bizId) {
            dtCustomerList(bizId);
        },

        setMRNCustomer: function (id, name) {
        	setMRNCustomer(id, name);
        }
