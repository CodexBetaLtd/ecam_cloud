var MRNItemSelectModal = function () {
    ...
    var dtmrnItem = function (mrnId) {
        ...
        var oTable = $('#' + tableId).dataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: '../restapi/mrn/mrnitem?mrnId=' + mrnId,
                pages: 5
            }),
            columns: [{
                orderable: false,
    ...
    var setMRNItem = function (id, name, itemQuantity,remainingQuantity) {
        $("#mrnItemId").val(id);
    ...
    return {
        ...
        setMRNItem: function (id, name, itemQuantity,remainingQuantity) {
        	setMRNItem(id,name,itemQuantity,remainingQuantity);
        },
