    ...
    var dtMRNReturn = function () {
        ...
        var oTable = $('#tbl_mrn_return_list').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: "../restapi/mrnReturn/tabledata",
                pages: 5
            }),
            columns: [
                {
        ...
        $('#tbl_mrn_return_list_wrapper .dataTables_length select').select2();
        $('#tbl_mrn_return_list_column_toggler input[type="checkbox"]').change(function () {
