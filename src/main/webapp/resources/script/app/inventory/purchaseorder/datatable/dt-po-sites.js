...
var DatatableModalSites = function () {
    ...
    var initTable = function (tableId, url, method) {
        ...
        var oTable = $('#' + tableId).DataTable({
           ...
           rowClick : {
               sFunc: "DatatableModalSites." + method,
               aoData:[  
                   {
                       sName : "id",
    ...
    function setShipTo(id, name){
        $("#shipToId").val(id);
        $("#shipToName").val(name);
        $("#" + this.modalId).modal('toggle');
    };
    
    function setBillTo(id, name){
        $("#billToId").val(id);
        $("#billToName").val(name);
        $("#" + this.modalId).modal('toggle');
    };
    ...
    return {
        ...
        setShipTo: function (id, name) {
            setShipTo(id, name);
        },

        setBillTo: function (id, name) {
            setBillTo(id, name);
        }
    };
}();