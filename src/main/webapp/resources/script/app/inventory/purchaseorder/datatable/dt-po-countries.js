...
var DatatableModalCountries = function () {
    ...
    function setSupplierCountry(id, name){
        $("#supplierCountry").val(id);
        $("#supplierCountryName").val(name);
        $("#" + this.modalId).modal('toggle');
    };
    
    function setShipToCountry(id, name){
        $("#shipToCountry").val(id);
        $("#shipToCountryName").val(name);
        $("#" + this.modalId).modal('toggle');
    };
    
    function setBillToCountry(id, name){
        $("#billToCountry").val(id);
        $("#billToCountryName").val(name);
        $("#" + this.modalId).modal('toggle');
    };
    ...
    return {
        ...
        setSupplierCountry: function (id, name) {
            setSupplierCountry(id, name);
        },
        
        setShipToCountry: function (id, name) {
            setShipToCountry(id, name);
        },

        setBillToCountry: function (id, name) {
            setBillToCountry(id, name);
        },
    };
}();