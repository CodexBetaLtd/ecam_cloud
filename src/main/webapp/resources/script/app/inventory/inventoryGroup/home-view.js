var InventoryGroupHome = function () {
    ...
    var dtInventoryGroup = function () {
        var oTable = $('#tbl_inventory_group').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/inventorygroup/getDataTable",
                pages: 5
            }),
            columns: [
                {
        ...
        $('#tbl_inventory_group_wrapper .dataTables_length select').select2();
        $('#tbl_inventory_group_column_toggler input[type="checkbox"]').change(function () {
