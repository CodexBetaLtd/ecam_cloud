var App = function () {
    ...
    var initAppDataTable = function () {
        ...
        var oTable = $('#app_tbl').dataTable({
            ...
            aoColumnDefs: [{
                ...
                render: function (data, type, full, meta) {
                    return ButtonUtil.getHomeBtnWithURL("app", data)
                }
            }],
            oLanguage: {
        ...
        $('#app_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
        $('#app_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#app_tbl_wrapper .dataTables_length select').select2();
        $('#app_tbl_column_toggler input[type="checkbox"]').change(function () {
