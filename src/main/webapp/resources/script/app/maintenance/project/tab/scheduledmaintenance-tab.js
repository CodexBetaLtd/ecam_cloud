TabScheduledMaintenance = function () {
    ...
    var runScheduledMaintenanceDataTable = function (projectId) {
        var oTable = $('#scheduled_maintenance_tbl').dataTable({
            processing: true,
            serverSide: true,
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/scheduledmaintenance/tableDataByProject",
                pages: 5,
                data: {
                    "id": projectId
                },
        ...
        $('#scheduled_maintenance_tbl_wrapper .dataTables_length select').select2();

        $('#scheduled_maintenance_tbl_column_toggler input[type="checkbox"]').change(function () {
	...
	return {
		runScheduledMaintenanceDataTable : function (projectId) {
			runScheduledMaintenanceDataTable(projectId);
		}
    };
}();