var FileAddModal = function () {
    ...
    var runDropzone = function () {
    	var scheduledMaintenanceCode=$('#code').val()
      $(".dropzone").dropzone({
            paramName: "fileData",
            maxFilesize: 10.0, // MB
            addRemoveLinks: true,
	        ...
	        init: function() {
	          ...
	          sending: function(file, xhr, formData){
        	  	formData.append('fileRefId', scheduledMaintenanceCode);
	          },
       ...
       $('#fileRefId').val(scheduledMaintenanceCode)
    ...
    var initValidator = function () {
        ...
        form.validate({
            ...
            messages: {
            	fileName: "Please Insert File name",
