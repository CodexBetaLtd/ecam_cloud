/*********************************************************************
 * Scheduled Maintenance Log DataTable
 *********************************************************************/
var ScheduledMaintenanceLog = function () {
    ...
    var dtSmLog = function (smId) {

        var oTable = $('#sm_log_tbl').DataTable({
            processing: true,
            serverSide: true,
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/scheduledmaintenancelog/table-data-by-scheduled-maintenance",
                pages: 5,
                data: {
                    "id": smId
                },
        ...
        $('#sm_log_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
        $('#sm_log_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#sm_log_tbl_wrapper .dataTables_length select').select2();
        $('#sm_log_tbl_column_toggler input[type="checkbox"]').change(function () {
