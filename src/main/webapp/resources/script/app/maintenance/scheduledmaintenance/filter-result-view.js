var ScheduledTaskFilter = function () {
    ...
    var runDataTable = function (from, to) {
    	
        var oTable = $('#scheduled_task_tbl').dataTable(
            {
                processing: true,
                serverSide: true,
                ajax: $.fn.dataTable.pipeline({
                    url: "../restapi/scheduled-maintenance-trigger/tasks-between-dates?from=" + from +"&to=" + to,
                    pages: 5
                }),
                columns: [
                    {
...
////                        return getHomeBtnWithURL("scheduled-task", data);
//                    }
//                }],
                oLanguage: {
        ...
        $('#scheduled_task_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");

        $('#scheduled_task_tbl_wrapper .dataTables_length select').addClass("m-wrap small");

        $('#scheduled_task_tbl_wrapper .dataTables_length select').select2();

        $('#scheduled_task_tbl_column_toggler input[type="checkbox"]').change(function () {
