/*********************************************************************
 * Work Order Log DataTable
 *********************************************************************/
var WorkOrderLog = function () {
    ...
    var initWorkOrderLogTable = function (workOrderId) {
        ...
        var oTable = $('#work_order_log_tbl').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/workorderlog/tableDataByWorkOrder",
                pages: 5,
                data: {
                    "id": workOrderId
                },
        ...
        $('#work_order_log_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
        $('#work_order_log_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#work_order_log_tbl_wrapper .dataTables_length select').select2();

        $('#work_order_log_tbl_column_toggler input[type="checkbox"]').change(function () {
    ...
    return {
        init: function (workOrderId) {
            initWorkOrderLogTable(workOrderId);
        }
    };
}();