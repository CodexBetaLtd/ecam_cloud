...
var DatatableModalBusinessClassifications = function () {
    ...
    var initTable = function (tableId, url, method) {
        ...
        var oTable = $('#' + tableId).DataTable({
           ...
           rowClick : {
               sFunc: "DatatableModalBusinessClassifications." + method,
               aoData:[  
                   {
                       sName : "id",
    ...
    function setData(id, name){
        $("#businessClassificationId").val(id);
        $("#businessClassificationName").val(name);
