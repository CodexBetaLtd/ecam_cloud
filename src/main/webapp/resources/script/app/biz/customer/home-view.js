    ...
    var runDataTable = function () {
        var oTable = $('#customer_tbl').DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline( {
                url: "../restapi/customer/tabledata",
            	pages: 5
            } ),            
            columns : [ {
                orderable: false,
        ...
        $('#customer_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#customer_tbl_wrapper .dataTables_length select').select2();
        // initialzie select2 dropdown
        $('#customer_tbl_column_toggler input[type="checkbox"]').change(function () {
