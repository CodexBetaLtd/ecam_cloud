...
var dtStock = function () {
    ...
    var stockTable = function () {
    	var itemPartId = $("#partId").val();
    	var tableId = 'tblStock';
        var oTable = $('#' + tableId).dataTable({
            // processing: true,
            serverSide: true,
            ajax: $.fn.dataTable.pipeline({
                url: '../../restapi/stock/stockByAsset?partId=' + itemPartId,
                pages: 5
            }),
            columns: [{
                orderable: false,
            ...
            aoColumnDefs: [{
                ...
                data: "id",
                render: function (data, type, row, meta) {
                	var vars=[data,row.stockNo,row.qtyOnHand];
                    return "<div align='center'>" + ButtonUtil.getCommonBtnSelectWithMultipleVars("BinCardReportView.setStock", data, vars);
                }
            }],
            oLanguage: {
