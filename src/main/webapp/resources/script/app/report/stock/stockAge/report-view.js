var StockAgeReportView = function () {
    ...
    var runItemInput = function () {
        $("#itemCode").inputClear({
            ...
            btnMethod: "StockAgeReportView.itemView()",
        });
    };
    ...
    var itemView = function () {
        ...
        setTimeout(function () {
            var url = '../stockage/partView';
            $modal.load(url, '', function () {
                var func = "StockAgeReportView.setItem";
