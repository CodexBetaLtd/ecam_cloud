/*********************************************************************
 * Report Supplier DataTable
 *********************************************************************/
var dtSupplier = function () {
    ...
    var getSupplierTable = function (url, func) {
        var tableId = "tbl_modal_report_supplier";
    ...
    return {
        getSupplier: function (url, func) {
            getSupplierTable(url, func);
        },
