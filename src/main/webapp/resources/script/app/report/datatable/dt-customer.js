/*********************************************************************
 * Report Customer DataTable
 *********************************************************************/
var dtCustomer = function () {
    ...
    var getCustomerTable = function (url, func) {
        var tableId = "estimate_customer_tbl";
    ...
    //return "<button id='link" + data + "' onclick='" + func + "(\"" + data + "\",\"" + row.name + "\",\"" + row.address + "\",\"" + row.city + "\",\"" + row.province +  "\",\"" + row.postalCode + "\",\"" + row.telephone +"\");' type='button' class='btn btn-blue btn-squared btn-xs' data-dismiss='modal'> Select </button>";


    return {
        getCustomer: function (url, func) {
            getCustomerTable(url, func);
        },
