...
var dtStock = function () {
    ...
    var getDataTableStock = function (url, func) {
        ...
        var tableId = "tbl-dt-reprot-stock";
        var oTable = $('#' + tableId).dataTable({
            ...
            aoColumnDefs: [{
                ...
                data: "id",
                render: function (data, type, row, meta) {
                	var vars = [data, row.batchNo, row.qtyOnHand];
    ...
    var setStock = function (id, stockNo, qtyOnHand) {
        $("#stockId").val(id);
        $("#stockNo").val(stockNo);
        $("#lastQuantity").val(qtyOnHand);
        $('#master-modal').modal("hide");
    };


    return {
        getDataTableStock: function (url, func) {
            getDataTableStock(url, func);
        },

        setStock: function (id, stockNo, qtyOnHand) {
            setStock(id, stockNo, qtyOnHand);
        },
