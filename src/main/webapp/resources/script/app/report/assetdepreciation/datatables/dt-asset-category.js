var AssetCategoryDataTable = function () {
    ...
    function runDataTable(bizId) {
        
        var tableId = "assetCategoryTbl";
        ...
        var oTable = $('#' + tableId).DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
            	url: "../../restapi/assetCategory/tabledata?bizId=" + bizId,
                pages: 5
            }),
            columns: [{            	
                orderable: false,
            ...
            rowClick : {
                sFunc: "AssetCategoryDataTable.setAssetCategory",
                aoData:[  
                    {
                        sName : "id",
                    }, {
    ...
    function setAssetCategory(id, name) {
