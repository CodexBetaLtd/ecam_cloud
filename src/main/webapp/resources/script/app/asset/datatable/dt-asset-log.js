...
var AssetLog = function () {
    ...
    var dtAssetLog = function (assetId) { 
    	
    	if (assetId != null && assetId > 0) {
    		
	        var oTable = $('#asset_log_tbl').DataTable({
	            processing: true,
	            serverSide: true,
	            ajax: $.fn.dataTable.pipeline({
	                url: "../../restapi/assetlog/tableDataByAsset",
	                pages: 5,
	                data: {
	                    "id": assetId
	                },
	        ...
	        $('#asset_log_tbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
	        $('#asset_log_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
	        $('#asset_log_tbl_wrapper .dataTables_length select').select2();
	        $('#asset_log_tbl_column_toggler input[type="checkbox"]').change(function () {
