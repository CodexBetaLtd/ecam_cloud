var MeterReadingHistoryModel = function () {
    ...
    var initDataTable = function (meterReadingId, api_url) {
    	
        var oTable = $('#meter_reading_history_tbl').dataTable({
            processing: true,
            serverSide: true,
            ajax: $.fn.dataTable.pipeline({
                url: api_url + meterReadingId,
                pages: 5
            }),
            columns: [{
                orderable: false,
                ...
                {
                    data: 'assetMeterReadingName',
                    orderable: false,
                    searchable: false
                },
                {
                    data: 'assetMeterReadingValue',
                    orderable: false,
                    searchable: false
                },
                {
                ...
                {
                    data: 'assetMeterReadingValueAddedDate',
    ...
    return {
        ...
        init: function (meterReadingId, api_url) {
            initDataTable(meterReadingId, api_url);
        }
    };
}();