var BomSelectModel = function () {
    ...
    var initBomDataTable = function (bizId) {
    	...
    	var oTable = $('#bom_tbl').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: "../../restapi/bomgroup/bomgroup-by-business-tabledata?bizId=" + bizId,
                pages: 5
            }),
            columns: [{
                orderable: false,
        ...
        $('#bom_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#bom_tbl_wrapper .dataTables_length select').select2();
        // initialzie select2 dropdown
        $('#bom_tbl_column_toggler input[type="checkbox"]').change(function () {
    ...
    var addBOMPart = function (id, name) {
    	TabBom.addPartConsumeRefFromBom(id);
	};

    return {
        init: function (bizId) {
        	initBomDataTable(bizId);
        },
        
        addBOMPart : function(id, name) {
        	addBOMPart(id, name);
		}
    };
}();