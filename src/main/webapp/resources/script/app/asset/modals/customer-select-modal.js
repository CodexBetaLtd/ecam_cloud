var CustomerSelectModal = function () {
    ...
    var runDataTable = function () {
        ...
        $('#customer_select_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#customer_select_tbl_wrapper .dataTables_length select').select2();
