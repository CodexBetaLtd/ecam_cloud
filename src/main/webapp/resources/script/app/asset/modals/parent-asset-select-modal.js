var ParentAssetSelectModal = function () {
    ...
    var runDataTable = function () {
        ...
        $('#parent_asset_select_tbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#parent_asset_select_tbl_wrapper .dataTables_length select').select2();
