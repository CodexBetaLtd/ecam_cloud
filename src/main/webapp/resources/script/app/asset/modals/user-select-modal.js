var UserSelectModel = function () {
    ...
    var initUserSelectDataTable = function ( bizId ) {
        ...
        $('#tbl-user-select_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#tbl-user-select_wrapper .dataTables_length select').select2();
        // initialzie select2 dropdown
        $('#tbl-user-select_columnToggler input[type="checkbox"]').change(function () {
