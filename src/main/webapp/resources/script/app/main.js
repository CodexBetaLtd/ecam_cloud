...
var Main = function () {
    ...
    var runModuleTools = function () {
        ...
        $('.panel-tools .panel-refresh').on('click', function (e) {
            ...
            el.block({
                ...
                message: '<img src="../resources/images/loading.gif" /> Just a moment...',
                css: {
                    border: 'none',
                    color: '#333',
                    background: 'none'
    ...
    var activeMenu = function () {   
    	...
    	var pgurl = window.location.href.substr(window.location.href.indexOf("/FOCUS_CMMS"));

        $(".main-navigation-menu li a").each(function () {
        	
        	var index = pgurl.indexOf($(this).attr("href"));
