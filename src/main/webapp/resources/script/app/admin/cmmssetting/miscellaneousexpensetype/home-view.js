var MiscellaneousExpenseTypeHome = function() {
	...
	var addModal = function() {
		...
		setTimeout(function() {
			var url = '../miscellaneousexpensetype/add';
			$modal.load(url, '', function() {
				$modal.modal();
				MiscellaneousExpenseTypAdd.init();
			});
		}, 1000);
	};
	...
	var editModal = function(id) {
		...
		$.ajax({
			url : '../miscellaneousexpensetype/edit?id=' + id,
			type : 'GET',
	...
	var saveModal = function() {
		var $modal = $('#cmms-setting-add-modal');
		var form = $('#miscellaneousExpenseTypeAddForm');
	...
	var deleteInsideModal = function(id) {
		var $modal = $('#cmms-setting-add-modal');
		$.ajax({
			url : '../miscellaneousexpensetype/delete?id=' + id,
			type : 'GET',
			success : function(response) {
				closeModal();
				runDataTable();
