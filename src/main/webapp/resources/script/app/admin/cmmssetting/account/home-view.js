	...
	var runDataTable = function() {
		...
		var oTable = $('#accountTbl').DataTable( {
			...
			"ajax" : $.fn.dataTable.pipeline({
						url : "../restapi/lookuptable/tabledataaccount",
						pages : 5
					}),
			columns : [
					{ 
		...
		$('#accountTbl_wrapper .dataTables_length select').addClass("m-wrap small");
		// modify table per page dropdown
		$('#accountTbl_wrapper .dataTables_length select').select2();
		// initialzie select2 dropdown
		$('#accountTbl_columnToggler input[type="checkbox"]').change(function() {
