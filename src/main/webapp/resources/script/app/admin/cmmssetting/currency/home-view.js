var CurrencyHome = function () {
    ...
    var runDataTable = function () {
        ...
        var oTable = $('#currencyTbl').DataTable({
            ...
            dom: "<'row'<'col-sm-4 dtblcurrency'><'col-sm-8'f>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-6'i><'col-sm-6'p>>",
        ...
        $('#currencyTbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#currencyTbl_wrapper .dataTables_length select').select2();
        // initialzie select2 dropdown
        $('#currencyTbl_columnToggler input[type="checkbox"]').change(function () {
