var AssetModelHome = function() {
	...
	var runDataTable = function() {
		...
		$('#assetModelsTbl_wrapper .dataTables_length select').select2();
		$('#assetModelsTbl_column_toggler input[type="checkbox"]').change(function() {
