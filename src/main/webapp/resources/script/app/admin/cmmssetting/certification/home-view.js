var CertificationHome = function() {
	...
	var runDataTable = function() {
		...
		var oTable = $('#certificationTbl').DataTable( {
			...
			"ajax" : $.fn.dataTable.pipeline({
						url : "../restapi/lookuptable/tabledataCertification",
						pages : 5
					}),
			columns : [
					{
		...
		$('#certificationTbl_wrapper .dataTables_length select').addClass("m-wrap small");
	...
	var addModal = function() {
		...
		setTimeout(function() {
			var url = '../certification/add';
			$modal.load(url, '', function() {
				$modal.modal();
				CertificationAdd.init();
			});
		}, 1000);
	};
	...
	var deleteModal = function(id) {
		$.ajax({
			url : '../certification/delete?id=' + id,
			type : 'GET',
			success : function(response) {
				runDataTable();
			},
