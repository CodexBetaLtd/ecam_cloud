var JobTitleHome = function() {
	...
	var runDataTable = function() {
		...
		$('#jobtitleTbl_wrapper .dataTables_filter input').addClass("form-control input-sm").attr("placeholder", "Search");
		// modify table search input
		$('#jobtitleTbl_wrapper .dataTables_length select').addClass("m-wrap small");
		// modify table per page dropdown
		$('#jobtitleTbl_wrapper .dataTables_length select').select2();
		// initialzie select2 dropdown
		$('#jobtitleTbl_columnToggler input[type="checkbox"]').change(function() {
