	...
	var runDataTable = function() {
		...
		var oTable = $('#prioritiesTbl').DataTable( {
			...
			"ajax" : $.fn.dataTable.pipeline({
						url : "../restapi/lookuptable/tabledataPriorities",
						pages : 5
					}),
			columns : [
					{ 
		...
		$('#prioritiesTbl_wrapper .dataTables_length select').addClass("m-wrap small");
