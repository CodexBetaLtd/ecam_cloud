var CertificationTypeTable = function () {
    ...
    var initDataTable = function () {
        ...
        var oTable = $('#certificationTypeSelectTbl').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline({
                url: "../restapi/users/getCertificationType",
                pages: 5
            }),
            columns: [{
                orderable: false,
        ...
        $('#certificationTypeSelectTbl_wrapper .dataTables_length select').addClass("m-wrap small");
        $('#certificationTypeSelectTbl_wrapper .dataTables_length select').select2();
        $('#certificationTypeSelectTbl_column_toggler input[type="checkbox"]').change(function () {
