    ...
    var runDataTable = function () {
        ...
        var oTable = $('#userGroupTbl').DataTable({
            ...
            ajax: $.fn.dataTable.pipeline( {
                url: "../restapi/userGroups/tabledata",
            	pages: 5
            } ),            
            columns : [ {
            	orderable: false, 
        ...
        $('#userGroupTbl_wrapper .dataTables_length select').addClass("m-wrap small");
        // modify table per page dropdown
        $('#userGroupTbl_wrapper .dataTables_length select').select2();
        // initialzie select2 dropdown
        $('#userGroupTbl_columnToggler input[type="checkbox"]').change(function () {
