var TaskAddModal = function () {
    ...
    var addTask = function () {
    	...
    	if ( $("#task-add-frm").valid() ) {   		
        	...
        	CustomValidation.validateFieldNull(task, 'assetCatgoryVersionId', $('#assetCatgoryVersionId').val());
        	CustomValidation.validateFieldNull(task, 'assetCatgoryTaskId', $('#assetCatgoryTaskId').val());
    ...
    var fillScheduledTask = function (task) {
        ...
        $("#taskId").val(task.id);
        $("#assetCatgoryTaskId").val(task.assetCatgoryTaskId);
        $("#assetCatgoryVersionId").val(task.assetCatgoryVersionId);
