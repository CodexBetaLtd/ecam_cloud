...
@RestController
@RequestMapping(MrnReturnReportRestController.REQUEST_MAPPING_URL)
public class MrnReturnReportRestController {

	public static final String REQUEST_MAPPING_URL = "restapi/report/mrnreturn";
