...
@RestController
@RequestMapping(MRNReportRestController.REQUEST_MAPPING_URL)
public class MRNReportRestController {

	public static final String REQUEST_MAPPING_URL = "restapi/report/mrn";
