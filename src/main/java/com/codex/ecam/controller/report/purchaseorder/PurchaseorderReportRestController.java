...
@RestController
@RequestMapping(PurchaseorderReportRestController.REQUEST_MAPPING_URL)
public class PurchaseorderReportRestController {

	public static final String REQUEST_MAPPING_URL = "restapi/report/po";
