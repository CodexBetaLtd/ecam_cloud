package com.codex.ecam.dto.inventory.issuenote;
...
public class IssueNoteDTO extends BaseDTO {
    ...
    private AODType aodType = AODType.ISSUE_NOTE;

    private String name;
    private String description;

    private List<IssueNoteItemDTO> aodItemList = new ArrayList<>();
    ...
    public List<IssueNoteItemDTO> getAodItemList() {
        return aodItemList;
    }

    public void setAodItemList(List<IssueNoteItemDTO> aodItemList) {
