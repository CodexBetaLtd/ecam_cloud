package com.codex.ecam.dto.report.data.mrnReturn;
...
public class MrnReturnRepDTO extends BaseReportDTO {
    ...
    private List<MrnReturnRepItemDTO> mrnReturnRepItemDTOs=new ArrayList<>();
	...
	public List<MrnReturnRepItemDTO> getMrnReturnRepItemDTOs() {
		return mrnReturnRepItemDTOs;
	}
	public void setMrnReturnRepItemDTOs(List<MrnReturnRepItemDTO> mrnReturnRepItemDTOs) {
		this.mrnReturnRepItemDTOs = mrnReturnRepItemDTOs;
	}
