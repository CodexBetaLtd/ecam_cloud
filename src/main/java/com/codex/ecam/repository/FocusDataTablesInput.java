...
@Data
public class FocusDataTablesInput {
	   ...
	   */
	  @NotEmpty
	  private List<FocusColumn> columns = new ArrayList<FocusColumn>();

	  /**
	   * 
	   * @return a {@link Map} of {@link FocusColumn} indexed by name
	   */
	  public Map<String, FocusColumn> getColumnsAsMap() {
	    Map<String, FocusColumn> map = new HashMap<String, FocusColumn>();
	    for (FocusColumn column : columns) {
	   ...
	   */
	  public FocusColumn getColumn(String columnName) {
	    if (columnName == null) {
	      return null;
	    }
	    for (FocusColumn column : columns) {
	   ...
	   */
	  public void addColumn(String columnName, boolean searchable, boolean orderable, String searchValue, boolean isEnum) {
	    this.columns.add(new FocusColumn(columnName, "", searchable, orderable, new Search(searchValue, false), isEnum));
	  }
