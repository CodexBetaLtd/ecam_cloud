...
public class ScheduledMaintenancePartLogListener extends LogListener<ScheduledMaintenancePart>{
	...
	public  String getNotes() {
		return "Scheduled Maintenance Part";
	}

	@Override
	public  BaseModel getLogDomain(ScheduledMaintenancePart domain) {
		return domain.getScheduledMaintenanceTask().getScheduledMaintenanceTrigger().getScheduledMaintenance();
	}
