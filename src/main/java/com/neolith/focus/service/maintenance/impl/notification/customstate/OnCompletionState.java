...
import com.neolith.focus.service.maintenance.impl.notification.custom.OnCompletionObserver;

public class OnCompletionState implements State {
    ...
    public OnCompletionState(EmailNotificationSubject emailNotificationSubject, EmailAndNotificationSender emailAndNotificationSender) {
