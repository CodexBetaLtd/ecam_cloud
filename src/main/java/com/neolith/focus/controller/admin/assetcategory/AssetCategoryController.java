package com.neolith.focus.controller.admin.assetcategory;
...
public class AssetCategoryController {
    ...
    List<AssetCategoryDTO> selectParent(@PathVariable("assetCategoryType") AssetCategoryType type) {
        List<AssetCategoryDTO> assetCategories = assetCategoryService.findByAssetCategoyType(type);
    ...
    public String findByIDAssetCategory(Integer id, Model model, RedirectAttributes ra) {
        try {
            AssetCategoryDTO assetCategoryDTO = assetCategoryService.findById(id);
    ...
    public String deleteAssetCategory(Integer id, Model model) {
        ...
        AssetCategoryResult result = assetCategoryService.delete(id);
