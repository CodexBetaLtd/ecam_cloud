...
import com.neolith.focus.listeners.rootaware.RootAwareEventListenerIntegrator;
import com.neolith.focus.repository.FocusDataTablesRepositoryFactoryBean;
import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@EnableJpaRepositories(basePackages = { "com.neolith.focus.dao" }, repositoryFactoryBeanClass = FocusDataTablesRepositoryFactoryBean.class)
...
public class DatabaseConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
		...
		entityManagerFactoryBean.setPackagesToScan("com.neolith.focus.model");
