package com.neolith.focus.dto.inventory.aod;
...
public class AODRepDTO extends BaseReportDTO {
    ...
    private List<AODItemRepDTO> aodItemRepDTOs = new ArrayList<>();
    ...
    public List<AODItemRepDTO> getAodItemRepDTOs() {
        return aodItemRepDTOs;
    }

    public void setAodItemRepDTOs(List<AODItemRepDTO> aodItemRepDTOs) {
